...
wrangler d1 execute unquizzable-db --remote --command `
    "SELECT COUNT(*) as total_base, (SELECT COUNT(*) FROM question_translation) as total_translations FROM question_base"
Pop-Location
